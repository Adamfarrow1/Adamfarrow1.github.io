...
function move2edit(){
	console.log("2edit");
	if(!document.getElementById(idSelected + '-name').value) return;
	
    document.getElementById('everything-container').style.transform = "translate(-75%)";
	document.getElementById('form-label').innerHTML = "EDIT CONTACT";


	let conname = document.getElementById(idSelected + '-name').value;
	let conphone = document.getElementById(idSelected + '-phone').value;
	let conemail = document.getElementById(idSelected + '-email').value;
	let condate = document.getElementById(idSelected + '-date').value;
